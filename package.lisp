...
(eval-when (:compile-toplevel :load-toplevel :execute)
  ;; The trivial-gray-streams system (ASDF) provides compatibiilty for
  ;; Gray Streams implementations onto ANSI Common Lisp
  ;;
  ;; This form ensures that symbols exported by Trivial Gray Streams
  ;; will be avaialble as external symbols via the package
  ;; #:CLIM-LISP, as effectively shadowing any corresponding
  ;; symbols defined in the implementation's Common Lisp
  ;; implementation.
  ;;
  ;; Symbols defined in the implementation's #:CL package and not
  ;; effectively shadowed by Trivial Gray Streams will also be
  ;; available as external symbols in the package #:CLIM-LISP
